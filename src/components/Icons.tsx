...
// Letsur 로고 — currentColor로 렌더링되는 단색 버전 (원본 브랜드 컬러: #00c781)
export const LetsurLogoIcon = ({ className }: IconProps) => (
  <svg
    className={className}
    viewBox="0 0 609 78"
    fill="currentColor"
    aria-hidden="true"
  >
    <path d="M352.156 6.34766V18.7046H321.771V71.7584H307.923V18.7046H277.539V6.34766H352.156Z" />
    <path d="M261.48 6.34766H192.743V18.7046H261.48V6.34766Z" />
    <path d="M261.48 59.4014H192.743V71.7585H261.48V59.4014Z" />
    <path d="M261.48 32.8174H192.743V45.1742H261.48V32.8174Z" />
    <path d="M553.99 23.8343V71.7532H540.268V20.807C540.268 11.4774 545.657 6.34766 555.464 6.34766H609.003V18.7046H559.383C555.951 18.7046 553.99 20.5695 553.99 23.8343Z" />
    <path d="M424.087 43.0762L386.715 27.4544C384.017 26.2869 380.592 25.0058 381.323 21.7409C382.056 18.4761 385.857 18.7086 387.943 18.7086H433.765V6.35165L384.266 6.11914C377.773 6.11914 370.544 7.16785 366.497 14.1625C362.578 20.9247 364.169 31.0704 375.321 35.7302L416.484 52.9844C420.407 54.6169 419.428 59.3954 414.896 59.3954H366.497V71.7522H418.445C426.778 71.7522 433.517 68.1363 435.105 61.2602C436.82 54.0332 434.492 47.3847 424.08 43.0713L424.087 43.0762Z" />
    <path d="M508.161 71.7584H466.137C456.334 71.7584 450.945 66.6286 450.945 57.2988V6.34766H464.667V54.1528C464.667 57.4178 466.628 59.2826 470.056 59.2826H504.242C507.674 59.2826 509.631 57.4178 509.631 54.1528V6.34766H523.357V57.2988C523.357 66.6286 517.964 71.7584 508.161 71.7584Z" />
    <path d="M107.972 57.2988L108.096 6.34766H121.82V54.2666C121.82 57.5315 123.779 59.3964 127.211 59.3964H176.834V71.7532H123.291C113.368 71.7532 107.977 66.6237 107.977 57.2939L107.972 57.2988Z" />
    <path d="M10.6306 38.9981C10.6306 47.0564 8.25493 53.5961 5.31267 53.5961C2.37043 53.5961 0 47.0564 0 38.9981C0 30.94 2.37563 24.4004 5.31267 24.4004C8.24972 24.4004 10.6306 30.935 10.6306 38.9981Z" />
    <path d="M81.9667 39C81.9667 60.5381 63.6165 78 40.9833 78H40.8844C40.8323 78 40.7754 78 40.7233 78C37.3391 77.7179 34.4385 68.6706 33.0817 55.6803C33.0244 55.1262 32.9674 54.5623 32.9153 53.9935C31.3039 65.5193 27.8782 73.464 23.9171 73.464C18.3965 73.464 13.9155 58.0398 13.9155 39.0049C13.9155 19.9699 18.3913 4.53616 23.9119 4.53616C27.873 4.53616 31.2987 12.4856 32.9101 24.0114C32.9622 23.4425 33.0195 22.8786 33.0764 22.3246C34.4333 9.33449 37.3339 0.281964 40.7181 0C40.7701 0 40.8271 0 40.8792 0H40.978C63.6116 0 81.9615 17.457 81.9615 39H81.9667Z" />
  </svg>
);
